...
public class Main {
    public static void main(String[] args) {
        ...
        // Alice sends commands through the proxy
        proxy.sendCommand("Alice", "1", "turnOn");
        proxy.sendCommand("Alice", "3", "lock");

        // Set a trigger to turn off the light when the thermostat temperature exceeds 75
        hub.addTrigger("temperature > 75", "turnOff(1)");

        // Simulate temperature change
        thermostat.performAction("setTemp(76)");

        // Check triggers to execute actions based on conditions
        hub.checkTriggers();
